...
public class TotalStatistiques 
{
	@FXML
	...
	private ObservableList<String> intervalTotal=FXCollections.observableArrayList();
	
	@FXML
	private void initialize()
	{
		intervalTotal.add("0-10");
		intervalTotal.add("10-20");
		intervalTotal.add("20-30");
		intervalTotal.add("30-40");
		intervalTotal.add("40-50");
		intervalTotal.add("50-60");
		xAxis.setCategories(intervalTotal);
	}
	public void SetStats(List<Vacance> vacances)
	{
		...
		{
			series.getData().add(new XYChart.Data<>(intervalTotal.get(i), prixCounter[i]));
		}
